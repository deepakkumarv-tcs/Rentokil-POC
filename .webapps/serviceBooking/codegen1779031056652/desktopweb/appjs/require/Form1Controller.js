...
define("Form1ControllerActions", {
    ...
    */
    ...
    AS_Button_a40ae1bdbeb4456cac761c7cf4ab5f81: function AS_Button_a40ae1bdbeb4456cac761c7cf4ab5f81(eventobject) {
        var self = this;
        // This is your custom snippet for Cancel button
        Form1.TextFieldCstFullName.text = "";
        Form1.TextFieldCstHouse.text = "";
        Form1.TextFieldCstCity.text = "";
        Form1.TextFieldCstPincode.text = "";
        Form1.TextFieldCstEmail.text = "";
        Form1.TextFieldCstContact.text = "";
        Form1.TextFieldCstApartment.text = "";
        // Reset dropdowns / listboxes
        Form1.ListBoxState.selectedKey = "0"; // or default key
        Form1.ListBoxCountry.selectedKey = "0";
    }
});
