define("serviceBooking", function() {
    return function(controller) {
        function addWidgetsserviceBooking() {
            ...
            var CstfullNameLabel = new voltmx.ui.Label({
                "id": "CstfullNameLabel",
                "isVisible": true,
                "left": "10%",
            ...
            var TextFieldCstFullName = new voltmx.ui.TextBox2({
                ...
                "left": "10.00%",
                "onTextChange": controller.AS_TextField_i72f50cd485c42abb4b25a431ab9ed03,
            ...
            FlexLBR1.add(CstfullNameLabel, TextFieldCstFullName);
            ...
            var CstHouseLabel = new voltmx.ui.Label({
                "id": "CstHouseLabel",
                "isVisible": true,
                "left": "10%",
                "skin": "CopydefLabel0bcbdedba55754f",
            ...
            var TextFieldCstHouse = new voltmx.ui.TextBox2({
                ...
                "keyBoardStyle": constants.TEXTBOX_KEY_BOARD_STYLE_DEFAULT,
                "left": "10.00%",
                "onTextChange": controller.AS_TextField_bce4abcd437c41699d274d4096a7752d,
                "secureTextEntry": false,
                "skin": "TextFieldPincode",
                "textInputMode": constants.TEXTBOX_INPUT_MODE_ANY,
                "width": "45%",
            ...
            FlexLBR3.add(CstHouseLabel, TextFieldCstHouse);
            ...
            var CstCityLabel = new voltmx.ui.Label({
                "id": "CstCityLabel",
                "isVisible": true,
                "left": "10%",
                "skin": "CopydefLabel0bcbdedba55754f",
            ...
            var TextFieldCstCity = new voltmx.ui.TextBox2({
                ...
                "keyBoardStyle": constants.TEXTBOX_KEY_BOARD_STYLE_DEFAULT,
                "left": "10.00%",
                "onTextChange": controller.AS_TextField_c688264974e44f95b99724a845562cfa,
                "secureTextEntry": false,
                "skin": "TextFieldPincode",
                "textInputMode": constants.TEXTBOX_INPUT_MODE_ANY,
                "width": "45%",
            ...
            FlexLBR4.add(CstCityLabel, TextFieldCstCity);
            ...
            var CstpincodeLabel = new voltmx.ui.Label({
                "id": "CstpincodeLabel",
                "isVisible": true,
                "left": "10%",
                "skin": "CopydefLabel0bcbdedba55754f",
            ...
            var TextFieldPincode = new voltmx.ui.TextBox2({
                ...
                "keyBoardStyle": constants.TEXTBOX_KEY_BOARD_STYLE_DEFAULT,
                "left": "10.00%",
                "onTextChange": controller.AS_TextField_cc0073c3c357480784586db0f3caa3cd,
                "secureTextEntry": false,
                "skin": "TextFieldPincode",
                "textInputMode": constants.TEXTBOX_INPUT_MODE_ANY,
                "width": "45%",
            ...
            FlexLBR5.add(CstpincodeLabel, TextFieldPincode);
            ...
            var CstDescriptionLabel = new voltmx.ui.Label({
                "id": "CstDescriptionLabel",
                "isVisible": true,
                "left": "10%",
                "skin": "CopydefLabel0bcbdedba55754f",
            ...
            var TextAreaDes = new voltmx.ui.TextArea2({
                ...
                "onTextChange": controller.AS_TextArea_he31a516f1964dd595de7b66886d9380,
            ...
            FlexLBR6.add(CstDescriptionLabel, TextAreaDes);
            ...
            FlexLeftBoxContainer.add(FlexLBR1, FlexLBR3, FlexLBR4, FlexLBR5, FlexLBR6, FlexLBR2);
            ...
            var CstNumberLabel = new voltmx.ui.Label({
                "id": "CstNumberLabel",
                "isVisible": true,
                "left": "10%",
                "skin": "CopydefLabel0bcbdedba55754f",
            ...
            var TextFieldCstContactNumber = new voltmx.ui.TextBox2({
                ...
                "keyBoardStyle": constants.TEXTBOX_KEY_BOARD_STYLE_DEFAULT,
                "left": "10.00%",
                "onTextChange": controller.AS_TextField_ec458bad1f8d487c92e2e8f0a7d20c36,
                "secureTextEntry": false,
                "skin": "TextFieldPincode",
            ...
            FlexRBR1.add(CstNumberLabel, TextFieldCstContactNumber);
            ...
            var CstServiceTypeLabel = new voltmx.ui.Label({
                "id": "CstServiceTypeLabel",
                "isVisible": true,
                "left": "10%",
                "skin": "CopydefLabel0bcbdedba55754f",
                "text": "Service type",
            ...
            var ListBoxServiceType = new voltmx.ui.ListBox({
                ...
                "onSelection": controller.AS_ListBox_f04a1c951a1546a7b25c182150a58381,
                "right": 0,
            ...
            FlexRBR2.add(CstServiceTypeLabel, ListBoxServiceType);
            ...
            var CstStateLabel = new voltmx.ui.Label({
                "id": "CstStateLabel",
                "isVisible": true,
                "left": "10%",
                "skin": "CopydefLabel0bcbdedba55754f",
            ...
            var ListBoxState = new voltmx.ui.ListBox({
                ...
                "onSelection": controller.AS_ListBox_cad5f926a9a14a86a42823195d643caf,
                "right": "0",
            ...
            FlexRBR4.add(CstStateLabel, ListBoxState);
            ...
            var CstCountryLabel = new voltmx.ui.Label({
                "id": "CstCountryLabel",
                "isVisible": true,
                "left": "10%",
                "onTouchStart": controller.AS_Label_bed4af43f81b441f87a076564685e36e,
                "skin": "CopydefLabel0bcbdedba55754f",
                "text": "Country",
                "top": "0%",
                "width": voltmx.flex.USE_PREFERRED_SIZE,
            ...
            var ListBoxCountry = new voltmx.ui.ListBox({
                ...
                "onSelection": controller.AS_ListBox_ace82d3c177e426cb9538fd5df3da32c,
            ...
            FlexRBR5.add(CstCountryLabel, ListBoxCountry);
            ...
            var CstAppartmentLabel = new voltmx.ui.Label({
                "id": "CstAppartmentLabel",
                "isVisible": true,
                "left": "10%",
                "skin": "CopydefLabel0bcbdedba55754f",
            ...
            var TextFieldCstAppartment = new voltmx.ui.TextBox2({
                ...
                "keyBoardStyle": constants.TEXTBOX_KEY_BOARD_STYLE_DEFAULT,
                "left": "10.00%",
                "onTextChange": controller.AS_TextField_de8592cf758943799cd252e7ba0be4b4,
                "secureTextEntry": false,
                "skin": "TextFieldPincode",
                "textInputMode": constants.TEXTBOX_INPUT_MODE_ANY,
                "width": "45%",
            ...
            FlexRBR3.add(CstAppartmentLabel, TextFieldCstAppartment);
            ...
            var ButtonSubmit = new voltmx.ui.Button({
                ...
                "id": "ButtonSubmit",
                "isVisible": true,
                "onClick": controller.AS_Button_fbe1ad3ab48849f0b27256efa3c5fe2e,
                "right": "0",
            ...
            var ButtonCancel = new voltmx.ui.Button({
                ...
                "isVisible": true,
                "left": "6dp",
                "onClick": controller.AS_Button_c144ef5f12e34d2485fbd5c815276144,
        ...
        return [{
            "addWidgets": addWidgetsserviceBooking,
            ...
            "appName": "Rentokil-POC",
            "info": {
                "kuid": "b617ced61ca84384a62d02c26eab4a1a"
            }
        }, {
