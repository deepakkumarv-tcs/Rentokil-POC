define("CopyflxSampleRowTemplate", function() {
    return function(controller) {
        var CopyflxSampleRowTemplate = new voltmx.ui.FlexContainer({
            "autogrowMode": voltmx.flex.AUTOGROW_NONE,
            "clipBounds": true,
            "height": "75dp",
            "id": "CopyflxSampleRowTemplate",
            "isVisible": true,
        ...
        CopyflxSampleRowTemplate.setDefaultUnit(voltmx.flex.DP);
        ...
        CopyflxSampleRowTemplate.add(lblHeading, lblDescription, lblTime, lblStrip);
        return CopyflxSampleRowTemplate;
    }
})